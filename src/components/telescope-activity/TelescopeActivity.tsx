...
import satellite from '../../assets/TelescopeActivity/satellite.png';
...
export default function TelescopeActivity({ history }: {
    history: {
    ...
    const cycleQuestionPopup = () => {
        setState(prev => ({
            ...prev,
            questionPopupOpened: !prev.questionPopupOpened
        }));
    };
    ...
    const startAnimation = () => {
        ...
        setState(prev => ({
            ...prev,
            animationRunning: !prev.animationRunning
        }));
    };
                            ...
                            <Container fluid style={{ margin: "0", padding: "0" }}>
                                <Row style={{ margin: 0 }}>
                                    <Col className="col-2" style={{ margin: "3%" }}>
                                        <Button
                                            ...
                                            onClick={() => history.push('/activity/metal-engraving')}
                                        >
                                ...
                                <Row style={{ margin: 0 }}>
                                    <Col className="justify-content-center align-content-center" style={{ padding: 0 }}>
                                        <div style={{ width: 1200, margin: "auto", height: 500 }}>
                                            ...
                                            <TelescopeGridContainer showGrid={state.showGrid} />
                                        </div>
                                    </Col>
                                </Row>
                                ...
                                <Row className="justify-content-center" style={{ margin: "3%" }}>
                                    ...
                                    <Col className="col-3 ml-auto mr-auto" style={{ padding: 0 }}>
                                        ...
                                        >
                                            {state.animationRunning ? 'Reset' : 'Start'} Simulation
                                        </Button>
                                    </Col>
                                    ...
                                    <Col className="ml-auto col-3" style={{ padding: 0 }}>
                                        <Button
                                            ...
                                            onClick={() => history.push('/activity/circuit-building')}
                                        >
                                            Next Activity
                                        </Button>
                                    </Col>
