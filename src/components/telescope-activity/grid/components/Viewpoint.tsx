...
export const Viewpoint: React.FC<ComponentProps> = ({oneGridStyling, x, y, currentComponent}) => {
            ...
            <Container fluid style={{...gridStyling}}>
                ...
                <Row className={"justify-content-center align-content-center"} style={{height: "100%"}}>
                    <Col ref={drag}
                        ...
                        <img alt={"Viewpoint"} src={viewpoint} style={{height: "100%", padding: 5, transform: "rotate(" + rotateDeg + "deg)"}} />
                    </Col>
                </Row>
            </Container>
        </>
