...
import inductor from '@/src/assets/CircuitBuilding/GridComponents/inductor.png'
...
export const Inductor: React.FC<ComponentProps> = ({x, y, oneGridStyling, currentComponent}) => {
